...
def normalize_date_text(raw_value) -> Optional[str]:
    """
    Normalize supported input date formats to YYYY-MM-DD.

    Accepts:
    - date/datetime-like objects
    - ISO timestamps like 2026-04-08T09:00:00
    - slash-formatted dates like 04/08/2026
    """
